...
names = ["Байрактар", "Джавелін", "Стефанія", "Харків", "Миколаїв", "Маріуполь", "Чернігів", "Суми",
         "Київ", "Вінинця", "Львів", "Херсон", "Одеса", "Севастополь", "Керч", "Донецьк",
         "Патріот", "Бандера"]
generation = 0
...
def run_game(genomes, config):
    ...
    heading_font = pygame.font.SysFont("Roboto Condensed", 40)
    ...
    while True:
        ...
        label = heading_font.render("Покоління: " + str(generation), True, (50, 50, 50))
        label_rect = label.get_rect()
        label_rect.center = (width / 2, 50)
        screen.blit(label, label_rect)

        score_label = score_font.render("Game speed: " + str(game_speed / 8) + "x", True, (50, 50, 50))
        score_label_rect = score_label.get_rect()
